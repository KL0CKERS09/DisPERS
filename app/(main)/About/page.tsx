...
export default function About() {
    ...
    return (
        <section className="px-6 py-12 max-w-7xl mx-auto space-y-12 text-center">
            ...
            <div>
                ...
                <div className="grid gap-6 md:grid-cols-3">
                    {data.values.map((val, i) => (
                        <div key={i} className="bg-white p-6 shadow rounded-lg text-left">
                            <Image src={val.icon} alt={val.title} width={40} height={40} />
                            <h3 className="font-bold mt-4 mb-2">{val.title}</h3>
            ...
            <div>
                <h2 className="text-2xl font-semibold mb-6">Our Developer Team</h2>
